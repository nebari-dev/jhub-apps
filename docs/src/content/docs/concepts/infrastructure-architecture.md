...
description: How JHub Apps integrates with JupyterHub's Hub, proxy, and spawner subsystems.
---
...
configurations can be found under the [create apps](/create-apps/general-app/) section.
