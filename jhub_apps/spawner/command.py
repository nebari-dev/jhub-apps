...
presentation_path = "/Users/aktech/quansight/jhub-apps/jhub_apps/examples/panel_basic.py"
...
COMMANDS = {
    'voila': {
        'args': ['--destport=0', 'python3', '{-}m', 'voila', f'{presentation_path}',
                 '{--}port={port}',
                 '{--}no-browser',
    ...
    'streamlit': {
        'args': ['--destport=0', 'streamlit', 'run', f'{presentation_path}',
                 '{--}server.port={port}',
    ...
    'plotlydash': {
        'args': ['--destport=0', 'python3', '{-}m', 'plotlydash_tornado_cmd.main', f'{presentation_path}',
                 '{--}port={port}'],
        'env': {'DASH_REQUESTS_PATHNAME_PREFIX': '{base_url}/'}
    },
    'bokeh': {
        'args': ['--destport=0', 'python3', '{-}m', 'bokeh_root_cmd.main', f'{presentation_path}',
                 '{--}port={port}',
    ...
    'rshiny': {
        'args': ['--destport=0', 'python3', '{-}m', 'rshiny_server_cmd.main', f'{presentation_path}',
                 '{--}port={port}']
    }
